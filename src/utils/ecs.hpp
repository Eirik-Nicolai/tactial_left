...
template <typename component> bool has(entt::registry &reg, entt::entity &ent)
{
...
{
    if (auto getcomp = reg.try_get<component>(ent);
        reg.try_get<component>(ent) != nullptr) {
        comp = (*getcomp);
        return true;
    }
    return false;
...
// template <typename component>
// bool tryget_component(const entt::registry& reg, const entt::entity &ent, component
// &comp)
// {
...
template <typename component> component get(entt::registry &reg, entt::entity e)
{
    return reg.get<component>(e);
}

template <typename component> const component cget(entt::registry &reg, entt::entity e)
{
    return reg.get<component>(e);
}

template <typename component> component add(entt::registry &reg, entt::entity e)
{
