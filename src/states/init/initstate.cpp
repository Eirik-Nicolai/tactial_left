...
void InitState::init(TacticalGame *ge) { LOG_FUNC }
void InitState::cleanup(TacticalGame *ge) { LOG_FUNC }

void InitState::pause(TacticalGame *ge) { LOG_FUNC }
void InitState::resume(TacticalGame *ge) { LOG_FUNC }
...
void InitState::enter(TacticalGame *ge) { LOG_FUNC }
void InitState::exit(TacticalGame *ge) { LOG_FUNC }
